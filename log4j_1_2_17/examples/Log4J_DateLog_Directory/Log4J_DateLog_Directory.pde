/**
 * Log4J_DateLog_Directory
 * implementation of log4j for processing 
 * This file is modest jog4j code 
 * laminated onto    examples/data/CharacterStrings
 *
 * It creates a    timeStampUnique_$SketchDirectory.log    file in c:\logs       on windows machines
 * It creates a    timeStampUnique_$SketchDirectory.log    file in /home/pi/logs on non-windows machines
 *
